...
export default class Attribute extends React.Component {
  ...
  render() {
    ...
    return (searchText === '' || (('key' in attribute && attribute.key.search(re) > -1) || ('description' in attribute && attribute.description.search(re) > -1))) ? (
      <div className="brick">
        <div className="card" >
          ...
          <div style={{display: 'flex', justifyContent: 'flex-end'}}>
            ...
            {!attribute.nr && <a href="#" className="tiny-button" onClick={this.handleEdit}>edit</a>}
          </div>
        </div>
      </div>
    ) : null;
